  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        ...
        <br />
        <br />
        <Trans id="If ERPilot is working for you, you're all set — there's nothing to do. If it's not the right fit, you can cancel in one click before then and you won't be charged." />
      </MainText>
      <br />
...
BillingTrialConvertingEmail.PreviewProps = {
  ...
  interval: 'month',
  link: 'https://acme.erpilot.ru/settings/billing',
  locale: 'en',
