...
describe('ObjectSystemSideEffectsOnDeleteSideEffectHandlerService', () => {
  ...
  it('should spare a navigation command holding the derived identifier but targeting another object', () => {
    const DERIVED_NAVIGATION_COMMAND_UNIVERSAL_IDENTIFIER =
      getNavigationCommandUniversalIdentifier({
        applicationUniversalIdentifier: APPLICATION_UNIVERSAL_IDENTIFIER,
        objectUniversalIdentifier: OBJECT_UNIVERSAL_IDENTIFIER,
  ...
  it('should cascade-delete a navigation command matched by its derived identifier when the object carries no workspace id', () => {
    const DERIVED_NAVIGATION_COMMAND_UNIVERSAL_IDENTIFIER =
      getNavigationCommandUniversalIdentifier({
        applicationUniversalIdentifier: APPLICATION_UNIVERSAL_IDENTIFIER,
        objectUniversalIdentifier: OBJECT_UNIVERSAL_IDENTIFIER,
