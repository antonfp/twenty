...
import { invalidateCommandMenuItemReownCache } from 'src/database/commands/upgrade-version-command/2-35/utils/invalidate-command-menu-item-reown-cache.util';
...
@RegisteredWorkspaceCommand('2.35.0', 1787562741000)
@Command({
  name: 'upgrade:2-35:flag-standard-action-command-menu-items-system-side-effect',
  description:
