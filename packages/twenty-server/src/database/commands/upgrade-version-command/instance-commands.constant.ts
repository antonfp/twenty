...
import { ApplicationDependenciesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-34/2-34-instance-command-fast-1787690477904-application-dependencies';
...
export const INSTANCE_COMMANDS = [
  ...
  ApplicationDependenciesFastInstanceCommand,
];
