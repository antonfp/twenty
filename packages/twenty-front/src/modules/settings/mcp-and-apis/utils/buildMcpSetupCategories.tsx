    ...
    cards: [
      {
        title: t`Claude`,
        badge: t`Preset link`,
        description: t`Open Claude with the ERPilot connector name and MCP URL prefilled.`,
        ctaLabel: t`Install`,
    ...
    cards: [
      {
        ...
        description: t`Open Cursor's MCP installer with the ERPilot remote server config.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`Goose`,
        badge: t`Install link`,
        description: t`Add ERPilot as a Streamable HTTP extension in Goose.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        ...
        badge: t`Install link`,
        description: t`Open Replit with the ERPilot remote server config.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`LM Studio`,
        badge: t`Install link`,
        description: t`Add the ERPilot remote server with LM Studio's install link.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`Cline`,
        badge: t`Manual`,
        description: t`Configure the ERPilot MCP server manually in Cline.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Zed`,
        badge: t`Manual`,
        description: t`Add the ERPilot MCP server as a remote context server in Zed.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        ...
        badge: t`Manual`,
        description: t`Configure the ERPilot MCP server manually in Cascade.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Raycast`,
        badge: t`Settings`,
        description: t`Add the ERPilot MCP server from Raycast's MCP commands or settings.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Gemini CLI`,
        badge: t`CLI config`,
        description: t`Add the ERPilot MCP server in Gemini CLI settings.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`LibreChat`,
        badge: t`YAML config`,
        description: t`Add the ERPilot MCP server to your LibreChat configuration file.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        ...
        badge: t`Settings`,
        description: t`Add the ERPilot MCP server from Augment Code settings.`,
        ctaLabel: t`Docs`,
