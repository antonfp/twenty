...
import { STOCK_TRANSFER_ON_STOCK_TRANSFER_LINE_ID } from '../fields/stock-transfer-on-stock-transfer-line.field';
...
export default defineView({
  ...
  filters: [
    {
      universalIdentifier: '83359b02-c32e-4a56-afd9-bb30457bf6b1',
      fieldMetadataUniversalIdentifier: STOCK_TRANSFER_ON_STOCK_TRANSFER_LINE_ID,
