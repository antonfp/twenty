...
import { GOODS_POSTING_ON_GOODS_POSTING_LINE_ID } from '../fields/goods-posting-on-goods-posting-line.field';
...
export default defineView({
  ...
  filters: [
    {
      universalIdentifier: '22c6f100-cdaf-4d8b-ac6b-b80018f3797f',
      fieldMetadataUniversalIdentifier: GOODS_POSTING_ON_GOODS_POSTING_LINE_ID,
