...
import { SALES_INVOICE_ON_SALES_INVOICE_LINE_ID } from '../fields/sales-invoice-on-sales-invoice-line.field';
...
export default defineView({
  ...
  filters: [
    {
      universalIdentifier: 'd6f1470a-7bfb-44e1-ba88-4ab8bb342536',
      fieldMetadataUniversalIdentifier: SALES_INVOICE_ON_SALES_INVOICE_LINE_ID,
