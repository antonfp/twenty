...
import { SUPPLIER_PAYMENT_RECORD_PAGE_FIELDS_VIEW_ID } from '../views/supplier-payment-record-page-fields.view';
      ...
      widgets: [
        {
          ...
          configuration: {
            ...
            viewUniversalIdentifier: SUPPLIER_PAYMENT_RECORD_PAGE_FIELDS_VIEW_ID,
          },
        },
      ],
    },
