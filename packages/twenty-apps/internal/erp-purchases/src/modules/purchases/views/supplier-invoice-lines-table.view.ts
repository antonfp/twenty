...
import { SUPPLIER_INVOICE_ON_SUPPLIER_INVOICE_LINE_ID } from '../fields/supplier-invoice-on-supplier-invoice-line.field';
...
export default defineView({
  ...
  filters: [
    {
      universalIdentifier: '934b2bcc-e65f-409e-a41f-b1f2afe39892',
      fieldMetadataUniversalIdentifier: SUPPLIER_INVOICE_ON_SUPPLIER_INVOICE_LINE_ID,
